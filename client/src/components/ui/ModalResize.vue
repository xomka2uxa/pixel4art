<template #content>
  <div class="popup__wrapper">
    <div class="popup__up">
      <span class="popup__title">Размер холста</span>
        ...
        <div class="inner__content__grid">
          <div class="choose-size__wrapper">
            ...
            <p v-if="isSmallerSize" class="attention">
              Выбранный Вами размер меньше текущего, часть изображения будет обрезана
            </p>
          </div>
            ...
            <div class="choose-size__wrapper">
              ...
              <div class="flex">
                ...
                <div class="col-70">
                  ...
                  <div class="attention" v-if="isBiggerCol">Вы превысили максимально допустимые размеры холста</div>
                  <div
                    class="attention"
                    v-if="
                    ...
                    "
                  >
                    Вы превысили максимально допустимые размеры холста
                  </div>
                  <div class="attention __grey">Максимально допустимые размеры холста 800 на 600</div>
                </div>
              </div>
            </div>
          </div>
